...
if __name__ == "__main__":
    ...
    # ]
    golden_features = [
    'era5_blh', 'era5_blh_lag1', #'era5_blh_lag2', 'era5_blh_lag3', 
                'era5_blh_lead1', #'era5_blh_lead2', 'era5_blh_lead3', 
    'era5_d2m', 'era5_d2m_lag1', #'era5_d2m_lag2', 'era5_d2m_lag3', 
                'era5_d2m_lead1', #'era5_d2m_lead2', 'era5_d2m_lead3', 
    'era5_sp',  'era5_sp_lag1', #'era5_sp_lag2', 'era5_sp_lag3', 
                'era5_sp_lead1', #'era5_sp_lead2', 'era5_sp_lead3', 
    'era5_ssrd','era5_ssrd_lag1', #'era5_ssrd_lag2', 'era5_ssrd_lag3', 
                'era5_ssrd_lead1', #'era5_ssrd_lead2', 'era5_ssrd_lead3', 
    'era5_t2m', 'era5_t2m_lag1', #'era5_t2m_lag2', 'era5_t2m_lag3', 
                'era5_t2m_lead1', #'era5_t2m_lead2', 'era5_t2m_lead3', 
    'era5_tcwv','era5_tcwv_lag1', #'era5_tcwv_lag2', 'era5_tcwv_lag3', 
    ...
    'era5_wind_dir_100m', 'era5_wind_dir_100m_lag1', #'era5_wind_dir_100m_lag2', 'era5_wind_dir_100m_lag3', 
                          'era5_wind_dir_100m_lead1', #'era5_wind_dir_100m_lead2', 'era5_wind_dir_100m_lead3', 
    'era5_wind_dir_10m',  'era5_wind_dir_10m_lag1', #'era5_wind_dir_10m_lag2', 'era5_wind_dir_10m_lag3', 
                          'era5_wind_dir_10m_lead1', #'era5_wind_dir_10m_lead2', 'era5_wind_dir_10m_lead3', 
    'era5_wind_speed_100m','era5_wind_speed_100m_lag1', #'era5_wind_speed_100m_lag2', 'era5_wind_speed_100m_lag3', 
                          'era5_wind_speed_100m_lead1', #'era5_wind_speed_100m_lead2', 'era5_wind_speed_100m_lead3', 
    'era5_wind_speed_10m','era5_wind_speed_10m_lag1', #'era5_wind_speed_10m_lag2', 'era5_wind_speed_10m_lag3', 
                          'era5_wind_speed_10m_lead1', #'era5_wind_speed_10m_lead2', 'era5_wind_speed_10m_lead3', 
    'grid_lat', 'grid_lon', 'meic_nox', 'ndvi', 'ndvi_std', 
    'no2_amf_trop', 'no2_trop', 'no2_variance', 
    'co', 'co_variance', 'dem_mean', 'dem_std', 
    'ntl', 'sif_740', 'sif_variance'
]
